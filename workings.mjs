...
class IRCTC{
    ...
    async clicking_sign_button(){
        ...
        console.log(chalk.green('fetch successfull ✓'));
    ...
    async decode(){
        ...
        console.log(chalk.yellow('Decoding Captcha...'));
    ...
    async answer_captcha(){
        ...
        if (this.mancap === 'true')
                ...
                {
                    this.captcha_answer =   await this.decode();
                }
    ...
    async validate_user(){
        ...
        console.log(this.train_number,'-',this.from_stn,'-',
